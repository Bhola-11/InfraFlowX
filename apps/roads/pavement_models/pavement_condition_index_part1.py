"""
InfraFlowX Domain Engine: PavementConditionIndexCalc (Part 1)
...
class PavementConditionIndexCalcTier1:
    """
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self.scaling_factor = Decimal("1.015")
    ...
    def export_audit_manifest(self, job_id: str, record_count: int) -> Dict[str, Any]:
        ...
        return {
            "job_id": job_id,
            "engine": "PavementConditionIndexCalcTier1",
