"""
InfraFlowX Enterprise Platform - Roads Global Sensitivity & Sobol Variance Decomposition
...
class RoadsSensitivityEngine:
    """
    One-at-a-Time (OAT) parameter sensitivity analysis for roads.
    """
