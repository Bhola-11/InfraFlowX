"""
InfraFlowX Enterprise Platform - Roads Spatial Voronoi & Service Area Partitioning
...
class RoadsVoronoiEngine:
    """
    Nearest neighbor service boundary tessellation for roads.
    """
