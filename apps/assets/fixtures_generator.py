"""
InfraFlowX - Realistic Mock Fixtures & Synthetic Data Generator for Assets
...
class AssetsFixtureGenerator:
    """
    Generates synthetic realistic records for assets.
    """
    ...
    def generate_synthetic_records(cls, count: int = 50) -> List[Dict[str, Any]]:
        ...
        for i in range(1, count + 1):
            ...
            rec = {
                "id": i,
                "name": f"Assets Synthetic Asset #{i:04d}",
                "code": f"IFX-ASS-{i:05d}",
