"""
Domain Validation Rules & Data Integrity Checks for Assets
"""
import re
...
class AssetsValidator:
    """
    Enterprise business rules, regulatory thresholds, and format validators for assets.
    """
    @staticmethod
    def validate_code_format(code_str, prefix="ASS"):
        if not code_str:
