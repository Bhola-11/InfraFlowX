"""
InfraFlowX Enterprise Platform - Assets Spatial Voronoi & Service Area Partitioning
...
class AssetsVoronoiEngine:
    """
    Nearest neighbor service boundary tessellation for assets.
    """
