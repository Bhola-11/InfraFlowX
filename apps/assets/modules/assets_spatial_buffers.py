"""
InfraFlowX Enterprise Platform - Assets Spatial Corridor Buffer & Zone Dilation
...
class AssetsSpatialBufferEngine:
    """
    Calculates right-of-way buffer zone offsets around spatial centerlines for assets.
    """
