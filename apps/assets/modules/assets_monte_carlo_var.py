"""
InfraFlowX Enterprise Platform - Assets Value at Risk (VaR) Portfolio Engine
...
class AssetsValueAtRiskEngine:
    """
    Parametric Value at Risk (VaR) and Conditional VaR (CVaR / Expected Shortfall) for assets.
    """
