"""
InfraFlowX Enterprise Platform - Assets Global Sensitivity & Sobol Variance Decomposition
...
class AssetsSensitivityEngine:
    """
    One-at-a-Time (OAT) parameter sensitivity analysis for assets.
    """
