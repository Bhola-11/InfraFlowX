"""
InfraFlowX - Realistic Mock Fixtures & Synthetic Data Generator for Permissions
...
class PermissionsFixtureGenerator:
    """
    Generates synthetic realistic records for permissions.
    """
    ...
    def generate_synthetic_records(cls, count: int = 50) -> List[Dict[str, Any]]:
        ...
        for i in range(1, count + 1):
            ...
            rec = {
                "id": i,
                "name": f"Permissions Synthetic Asset #{i:04d}",
                "code": f"IFX-PER-{i:05d}",
