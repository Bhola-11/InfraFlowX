"""
InfraFlowX - JSON Schema & API Data Contract Definitions for Permissions App
...
PERMISSIONS_SCHEMA: Dict[str, Any] = {
    ...
    "title": "PermissionsPayloadSchema",
    "type": "object",
    "properties": {
        "id": {"type": "integer"},
...
def validate_permissions_payload(payload: Dict[str, Any]) -> bool:
