"""
InfraFlowX Enterprise Platform - Permissions Spatial Corridor Buffer & Zone Dilation
...
class PermissionsSpatialBufferEngine:
    """
    Calculates right-of-way buffer zone offsets around spatial centerlines for permissions.
    """
