"""
InfraFlowX Enterprise Platform - Permissions Global Sensitivity & Sobol Variance Decomposition
...
class PermissionsSensitivityEngine:
    """
    One-at-a-Time (OAT) parameter sensitivity analysis for permissions.
    """
