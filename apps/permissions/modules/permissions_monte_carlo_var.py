"""
InfraFlowX Enterprise Platform - Permissions Value at Risk (VaR) Portfolio Engine
...
class PermissionsValueAtRiskEngine:
    """
    Parametric Value at Risk (VaR) and Conditional VaR (CVaR / Expected Shortfall) for permissions.
    """
