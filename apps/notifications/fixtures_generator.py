"""
InfraFlowX - Realistic Mock Fixtures & Synthetic Data Generator for Notifications
...
class NotificationsFixtureGenerator:
    """
    Generates synthetic realistic records for notifications.
    """
    ...
    def generate_synthetic_records(cls, count: int = 50) -> List[Dict[str, Any]]:
        ...
        for i in range(1, count + 1):
            ...
            rec = {
                "id": i,
                "name": f"Notifications Synthetic Asset #{i:04d}",
                "code": f"IFX-NOT-{i:05d}",
