"""
InfraFlowX Enterprise Platform - Notifications Global Sensitivity & Sobol Variance Decomposition
...
class NotificationsSensitivityEngine:
    """
    One-at-a-Time (OAT) parameter sensitivity analysis for notifications.
    """
