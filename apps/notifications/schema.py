"""
InfraFlowX - JSON Schema & API Data Contract Definitions for Notifications App
Enforces strict schema validation for REST endpoints and external webhook integrations.
"""

from typing import Dict, Any

NOTIFICATIONS_SCHEMA: Dict[str, Any] = {
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "title": "NotificationsPayloadSchema",
    "type": "object",
    "properties": {
        "id": {"type": "integer"},
...
def validate_notifications_payload(payload: Dict[str, Any]) -> bool:
