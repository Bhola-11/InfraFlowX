"""
InfraFlowX Enterprise Platform - Incidents Global Sensitivity & Sobol Variance Decomposition
...
class IncidentsSensitivityEngine:
    """
    One-at-a-Time (OAT) parameter sensitivity analysis for incidents.
    """
