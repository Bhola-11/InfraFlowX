"""
InfraFlowX Enterprise Platform - Incidents Value at Risk (VaR) Portfolio Engine
...
class IncidentsValueAtRiskEngine:
    """
    Parametric Value at Risk (VaR) and Conditional VaR (CVaR / Expected Shortfall) for incidents.
    """
