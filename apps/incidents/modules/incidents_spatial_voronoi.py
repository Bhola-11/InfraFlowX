"""
InfraFlowX Enterprise Platform - Incidents Spatial Voronoi & Service Area Partitioning
...
class IncidentsVoronoiEngine:
    """
    Nearest neighbor service boundary tessellation for incidents.
    """
