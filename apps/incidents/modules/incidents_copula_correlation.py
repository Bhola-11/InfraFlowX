"""
InfraFlowX Enterprise Platform - Incidents Copula Joint Probability & Failure Dependence Engine
...
class IncidentsCopulaEngine:
    """
    Clayton Archimedean Copula for joint tail dependency modeling in incidents.
