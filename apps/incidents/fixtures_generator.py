"""
InfraFlowX - Realistic Mock Fixtures & Synthetic Data Generator for Incidents
...
class IncidentsFixtureGenerator:
    """
    Generates synthetic realistic records for incidents.
    """
    ...
    def generate_synthetic_records(cls, count: int = 50) -> List[Dict[str, Any]]:
        ...
        for i in range(1, count + 1):
            ...
            rec = {
                "id": i,
                "name": f"Incidents Synthetic Asset #{i:04d}",
                "code": f"IFX-INC-{i:05d}",
