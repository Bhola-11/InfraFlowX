"""
InfraFlowX Enterprise Platform - Schedules Spatial Geofencing & Corridor Engine
...
class SchedulesGeofenceEngine:
    """
    Geofencing and spatial corridor proximity detection for schedules.
    """
