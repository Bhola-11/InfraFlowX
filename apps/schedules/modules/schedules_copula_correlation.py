"""
InfraFlowX Enterprise Platform - Schedules Copula Joint Probability & Failure Dependence Engine
...
class SchedulesCopulaEngine:
    """
    Clayton Archimedean Copula for joint tail dependency modeling in schedules.
