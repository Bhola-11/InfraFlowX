"""
InfraFlowX Enterprise Platform - Schedules Global Sensitivity & Sobol Variance Decomposition
...
class SchedulesSensitivityEngine:
    """
    One-at-a-Time (OAT) parameter sensitivity analysis for schedules.
    """
