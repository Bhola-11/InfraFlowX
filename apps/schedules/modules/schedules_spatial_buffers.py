"""
InfraFlowX Enterprise Platform - Schedules Spatial Corridor Buffer & Zone Dilation
...
class SchedulesSpatialBufferEngine:
    """
    Calculates right-of-way buffer zone offsets around spatial centerlines for schedules.
    """
