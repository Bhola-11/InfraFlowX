"""
InfraFlowX Enterprise Platform - Schedules Value at Risk (VaR) Portfolio Engine
...
class SchedulesValueAtRiskEngine:
    """
    Parametric Value at Risk (VaR) and Conditional VaR (CVaR / Expected Shortfall) for schedules.
    """
