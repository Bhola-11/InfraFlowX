"""
InfraFlowX - Realistic Mock Fixtures & Synthetic Data Generator for Schedules
...
class SchedulesFixtureGenerator:
    """
    Generates synthetic realistic records for schedules.
    """
    ...
    def generate_synthetic_records(cls, count: int = 50) -> List[Dict[str, Any]]:
        ...
        for i in range(1, count + 1):
            ...
            rec = {
                "id": i,
                "name": f"Schedules Synthetic Asset #{i:04d}",
                "code": f"IFX-SCH-{i:05d}",
