"""
InfraFlowX - Realistic Mock Fixtures & Synthetic Data Generator for Maintenance
...
class MaintenanceFixtureGenerator:
    """
    Generates synthetic realistic records for maintenance.
    """
    ...
    def generate_synthetic_records(cls, count: int = 50) -> List[Dict[str, Any]]:
        ...
        for i in range(1, count + 1):
            ...
            rec = {
                "id": i,
                "name": f"Maintenance Synthetic Asset #{i:04d}",
                "code": f"IFX-MAI-{i:05d}",
