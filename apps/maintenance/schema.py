"""
InfraFlowX - JSON Schema & API Data Contract Definitions for Maintenance App
...
MAINTENANCE_SCHEMA: Dict[str, Any] = {
    ...
    "title": "MaintenancePayloadSchema",
    "type": "object",
    "properties": {
        "id": {"type": "integer"},
...
def validate_maintenance_payload(payload: Dict[str, Any]) -> bool:
