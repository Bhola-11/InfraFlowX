"""
InfraFlowX Enterprise Platform - Maintenance Global Sensitivity & Sobol Variance Decomposition
...
class MaintenanceSensitivityEngine:
    """
    One-at-a-Time (OAT) parameter sensitivity analysis for maintenance.
    """
