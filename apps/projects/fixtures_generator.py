"""
InfraFlowX - Realistic Mock Fixtures & Synthetic Data Generator for Projects
...
class ProjectsFixtureGenerator:
    """
    Generates synthetic realistic records for projects.
    """
    ...
    def generate_synthetic_records(cls, count: int = 50) -> List[Dict[str, Any]]:
        ...
        for i in range(1, count + 1):
            ...
            rec = {
                "id": i,
                "name": f"Projects Synthetic Asset #{i:04d}",
                "code": f"IFX-PRO-{i:05d}",
