"""
InfraFlowX Enterprise Platform - Projects Geospatial Telemetry & IoT Stream Parser
...
class ProjectsGeospatialTelemetryEngine:
    """
    Processes streaming sensor telemetry and spatial proximity alerts for projects.
    """
