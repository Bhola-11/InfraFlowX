"""
InfraFlowX Enterprise Platform - Projects Global Sensitivity & Sobol Variance Decomposition
...
class ProjectsSensitivityEngine:
    """
    One-at-a-Time (OAT) parameter sensitivity analysis for projects.
    """
