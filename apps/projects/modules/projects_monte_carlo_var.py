"""
InfraFlowX Enterprise Platform - Projects Value at Risk (VaR) Portfolio Engine
...
class ProjectsValueAtRiskEngine:
    """
    Parametric Value at Risk (VaR) and Conditional VaR (CVaR / Expected Shortfall) for projects.
    """
