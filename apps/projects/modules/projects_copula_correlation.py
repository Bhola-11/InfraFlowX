"""
InfraFlowX Enterprise Platform - Projects Copula Joint Probability & Failure Dependence Engine
...
class ProjectsCopulaEngine:
    """
    Clayton Archimedean Copula for joint tail dependency modeling in projects.
