"""
InfraFlowX Enterprise Platform - Bridges Global Sensitivity & Sobol Variance Decomposition
...
class BridgesSensitivityEngine:
    """
    One-at-a-Time (OAT) parameter sensitivity analysis for bridges.
    """
