"""
InfraFlowX Enterprise Platform - Bridges Value at Risk (VaR) Portfolio Engine
...
class BridgesValueAtRiskEngine:
    """
    Parametric Value at Risk (VaR) and Conditional VaR (CVaR / Expected Shortfall) for bridges.
    """
