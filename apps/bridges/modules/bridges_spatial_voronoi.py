"""
InfraFlowX Enterprise Platform - Bridges Spatial Voronoi & Service Area Partitioning
...
class BridgesVoronoiEngine:
    """
    Nearest neighbor service boundary tessellation for bridges.
    """
