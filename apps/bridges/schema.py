"""
InfraFlowX - JSON Schema & API Data Contract Definitions for Bridges App
Enforces strict schema validation for REST endpoints and external webhook integrations.
"""

from typing import Dict, Any

BRIDGES_SCHEMA: Dict[str, Any] = {
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "title": "BridgesPayloadSchema",
    "type": "object",
    "properties": {
        "id": {"type": "integer"},
...
def validate_bridges_payload(payload: Dict[str, Any]) -> bool:
