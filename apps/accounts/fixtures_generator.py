"""
InfraFlowX - Realistic Mock Fixtures & Synthetic Data Generator for Accounts
...
class AccountsFixtureGenerator:
    """
    Generates synthetic realistic records for accounts.
    """
    ...
    def generate_synthetic_records(cls, count: int = 50) -> List[Dict[str, Any]]:
        ...
        for i in range(1, count + 1):
            ...
            rec = {
                "id": i,
                "name": f"Accounts Synthetic Asset #{i:04d}",
                "code": f"IFX-ACC-{i:05d}",
