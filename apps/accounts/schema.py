"""
InfraFlowX - JSON Schema & API Data Contract Definitions for Accounts App
Enforces strict schema validation for REST endpoints and external webhook integrations.
"""

from typing import Dict, Any

ACCOUNTS_SCHEMA: Dict[str, Any] = {
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "title": "AccountsPayloadSchema",
    "type": "object",
    "properties": {
        "id": {"type": "integer"},
...
def validate_accounts_payload(payload: Dict[str, Any]) -> bool:
