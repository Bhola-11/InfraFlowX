"""
InfraFlowX Enterprise Platform - Accounts Value at Risk (VaR) Portfolio Engine
...
class AccountsValueAtRiskEngine:
    """
    Parametric Value at Risk (VaR) and Conditional VaR (CVaR / Expected Shortfall) for accounts.
    """
