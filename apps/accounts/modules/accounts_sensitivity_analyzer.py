"""
InfraFlowX Enterprise Platform - Accounts Global Sensitivity & Sobol Variance Decomposition
...
class AccountsSensitivityEngine:
    """
    One-at-a-Time (OAT) parameter sensitivity analysis for accounts.
    """
