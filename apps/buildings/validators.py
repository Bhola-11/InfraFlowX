"""
Domain Validation Rules & Data Integrity Checks for Buildings
"""
import re
...
class BuildingsValidator:
    """
    Enterprise business rules, regulatory thresholds, and format validators for buildings.
    """
    @staticmethod
    def validate_code_format(code_str, prefix="BUI"):
        if not code_str:
