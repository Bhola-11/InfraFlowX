"""
InfraFlowX Enterprise Platform - Buildings Value at Risk (VaR) Portfolio Engine
...
class BuildingsValueAtRiskEngine:
    """
    Parametric Value at Risk (VaR) and Conditional VaR (CVaR / Expected Shortfall) for buildings.
    """
