"""
InfraFlowX Enterprise Platform - Buildings Copula Joint Probability & Failure Dependence Engine
...
class BuildingsCopulaEngine:
    """
    Clayton Archimedean Copula for joint tail dependency modeling in buildings.
