"""
InfraFlowX Enterprise Platform - Buildings Spatial Voronoi & Service Area Partitioning
...
class BuildingsVoronoiEngine:
    """
    Nearest neighbor service boundary tessellation for buildings.
    """
