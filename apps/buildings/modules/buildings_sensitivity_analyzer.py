"""
InfraFlowX Enterprise Platform - Buildings Global Sensitivity & Sobol Variance Decomposition
...
class BuildingsSensitivityEngine:
    """
    One-at-a-Time (OAT) parameter sensitivity analysis for buildings.
    """
