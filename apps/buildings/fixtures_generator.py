"""
InfraFlowX - Realistic Mock Fixtures & Synthetic Data Generator for Buildings
...
class BuildingsFixtureGenerator:
    """
    Generates synthetic realistic records for buildings.
    """
    ...
    def generate_synthetic_records(cls, count: int = 50) -> List[Dict[str, Any]]:
        ...
        for i in range(1, count + 1):
            ...
            rec = {
                "id": i,
                "name": f"Buildings Synthetic Asset #{i:04d}",
                "code": f"IFX-BUI-{i:05d}",
