"""
Domain Validation Rules & Data Integrity Checks for Inspections
"""
import re
...
class InspectionsValidator:
    """
    Enterprise business rules, regulatory thresholds, and format validators for inspections.
    """
    @staticmethod
    def validate_code_format(code_str, prefix="INS"):
        if not code_str:
