"""
InfraFlowX - JSON Schema & API Data Contract Definitions for Inspections App
Enforces strict schema validation for REST endpoints and external webhook integrations.
"""

from typing import Dict, Any

INSPECTIONS_SCHEMA: Dict[str, Any] = {
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "title": "InspectionsPayloadSchema",
    "type": "object",
    "properties": {
        "id": {"type": "integer"},
...
def validate_inspections_payload(payload: Dict[str, Any]) -> bool:
