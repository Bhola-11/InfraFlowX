"""
InfraFlowX - Realistic Mock Fixtures & Synthetic Data Generator for Inspections
...
class InspectionsFixtureGenerator:
    """
    Generates synthetic realistic records for inspections.
    """
    ...
    def generate_synthetic_records(cls, count: int = 50) -> List[Dict[str, Any]]:
        ...
        for i in range(1, count + 1):
            ...
            rec = {
                "id": i,
                "name": f"Inspections Synthetic Asset #{i:04d}",
                "code": f"IFX-INS-{i:05d}",
