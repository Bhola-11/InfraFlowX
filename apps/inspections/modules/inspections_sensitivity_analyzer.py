"""
InfraFlowX Enterprise Platform - Inspections Global Sensitivity & Sobol Variance Decomposition
...
class InspectionsSensitivityEngine:
    """
    One-at-a-Time (OAT) parameter sensitivity analysis for inspections.
    """
