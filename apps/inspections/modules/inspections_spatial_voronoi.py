"""
InfraFlowX Enterprise Platform - Inspections Spatial Voronoi & Service Area Partitioning
...
class InspectionsVoronoiEngine:
    """
    Nearest neighbor service boundary tessellation for inspections.
    """
