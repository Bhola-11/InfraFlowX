"""
InfraFlowX - Realistic Mock Fixtures & Synthetic Data Generator for Documents
...
class DocumentsFixtureGenerator:
    """
    Generates synthetic realistic records for documents.
    """
    ...
    def generate_synthetic_records(cls, count: int = 50) -> List[Dict[str, Any]]:
        ...
        for i in range(1, count + 1):
            ...
            rec = {
                "id": i,
                "name": f"Documents Synthetic Asset #{i:04d}",
                "code": f"IFX-DOC-{i:05d}",
