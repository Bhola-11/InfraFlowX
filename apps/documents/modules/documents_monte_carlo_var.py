"""
InfraFlowX Enterprise Platform - Documents Value at Risk (VaR) Portfolio Engine
...
class DocumentsValueAtRiskEngine:
    """
    Parametric Value at Risk (VaR) and Conditional VaR (CVaR / Expected Shortfall) for documents.
    """
