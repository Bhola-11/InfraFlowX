"""
InfraFlowX Enterprise Platform - Organizations Value at Risk (VaR) Portfolio Engine
...
class OrganizationsValueAtRiskEngine:
    """
    Parametric Value at Risk (VaR) and Conditional VaR (CVaR / Expected Shortfall) for organizations.
    """
