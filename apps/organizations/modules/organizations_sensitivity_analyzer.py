"""
InfraFlowX Enterprise Platform - Organizations Global Sensitivity & Sobol Variance Decomposition
...
class OrganizationsSensitivityEngine:
    """
    One-at-a-Time (OAT) parameter sensitivity analysis for organizations.
    """
