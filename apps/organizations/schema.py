"""
InfraFlowX - JSON Schema & API Data Contract Definitions for Organizations App
...
ORGANIZATIONS_SCHEMA: Dict[str, Any] = {
    ...
    "title": "OrganizationsPayloadSchema",
    "type": "object",
    "properties": {
        "id": {"type": "integer"},
...
def validate_organizations_payload(payload: Dict[str, Any]) -> bool:
