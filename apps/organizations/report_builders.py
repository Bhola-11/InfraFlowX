"""
InfraFlowX - Executive & Technical Report Builder for Organizations
...
class OrganizationsReportBuilder:
    """
    Compiles operational summary reports for organizations.
    """
    ...
    def render_printable_html(cls, report_data: Dict[str, Any]) -> str:
        ...
        <div class="report-container" style="font-family: Arial, sans-serif; padding: 20px;">
            <div style="border-bottom: 2px solid #333; padding-bottom: 10px; margin-bottom: 20px;">
                ...
                <p style="margin: 5px 0 0; color: #718096;">Module: Organizations | Generated: {report_data.get('generated_at')}</p>
            </div>
