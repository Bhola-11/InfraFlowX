"""
InfraFlowX - Realistic Mock Fixtures & Synthetic Data Generator for Organizations
...
class OrganizationsFixtureGenerator:
    """
    Generates synthetic realistic records for organizations.
    """
    ...
    def generate_synthetic_records(cls, count: int = 50) -> List[Dict[str, Any]]:
        ...
        for i in range(1, count + 1):
            ...
            rec = {
                "id": i,
                "name": f"Organizations Synthetic Asset #{i:04d}",
                "code": f"IFX-ORG-{i:05d}",
