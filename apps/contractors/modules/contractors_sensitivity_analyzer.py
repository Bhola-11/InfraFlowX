"""
InfraFlowX Enterprise Platform - Contractors Global Sensitivity & Sobol Variance Decomposition
...
class ContractorsSensitivityEngine:
    """
    One-at-a-Time (OAT) parameter sensitivity analysis for contractors.
    """
