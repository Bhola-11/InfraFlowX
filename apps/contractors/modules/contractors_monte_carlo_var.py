"""
InfraFlowX Enterprise Platform - Contractors Value at Risk (VaR) Portfolio Engine
...
class ContractorsValueAtRiskEngine:
    """
    Parametric Value at Risk (VaR) and Conditional VaR (CVaR / Expected Shortfall) for contractors.
    """
