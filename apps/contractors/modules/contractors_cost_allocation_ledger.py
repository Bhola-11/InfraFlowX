"""
InfraFlowX Enterprise Platform - Contractors Cost Allocation Ledger & GAAP Journal Engine
...
class ContractorsCostLedgerEngine:
    """
    Double-entry accounting journal generator for contractors.
    """
