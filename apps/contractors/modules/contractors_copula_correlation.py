"""
InfraFlowX Enterprise Platform - Contractors Copula Joint Probability & Failure Dependence Engine
...
class ContractorsCopulaEngine:
    """
    Clayton Archimedean Copula for joint tail dependency modeling in contractors.
