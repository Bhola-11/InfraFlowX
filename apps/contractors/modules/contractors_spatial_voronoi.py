"""
InfraFlowX Enterprise Platform - Contractors Spatial Voronoi & Service Area Partitioning
...
class ContractorsVoronoiEngine:
    """
    Nearest neighbor service boundary tessellation for contractors.
    """
