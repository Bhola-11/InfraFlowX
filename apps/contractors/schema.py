"""
InfraFlowX - JSON Schema & API Data Contract Definitions for Contractors App
Enforces strict schema validation for REST endpoints and external webhook integrations.
"""

from typing import Dict, Any

CONTRACTORS_SCHEMA: Dict[str, Any] = {
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "title": "ContractorsPayloadSchema",
    "type": "object",
    "properties": {
        "id": {"type": "integer"},
...
def validate_contractors_payload(payload: Dict[str, Any]) -> bool:
