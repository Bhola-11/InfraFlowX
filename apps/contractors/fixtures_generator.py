"""
InfraFlowX - Realistic Mock Fixtures & Synthetic Data Generator for Contractors
...
class ContractorsFixtureGenerator:
    """
    Generates synthetic realistic records for contractors.
    """
    ...
    def generate_synthetic_records(cls, count: int = 50) -> List[Dict[str, Any]]:
        ...
        for i in range(1, count + 1):
            ...
            rec = {
                "id": i,
                "name": f"Contractors Synthetic Asset #{i:04d}",
                "code": f"IFX-CON-{i:05d}",
