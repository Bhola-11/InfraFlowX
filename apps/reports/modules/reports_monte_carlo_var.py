"""
InfraFlowX Enterprise Platform - Reports Value at Risk (VaR) Portfolio Engine
...
class ReportsValueAtRiskEngine:
    """
    Parametric Value at Risk (VaR) and Conditional VaR (CVaR / Expected Shortfall) for reports.
    """
