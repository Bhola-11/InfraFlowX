"""
InfraFlowX Enterprise Platform - Reports Global Sensitivity & Sobol Variance Decomposition
...
class ReportsSensitivityEngine:
    """
    One-at-a-Time (OAT) parameter sensitivity analysis for reports.
    """
