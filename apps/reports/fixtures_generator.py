"""
InfraFlowX - Realistic Mock Fixtures & Synthetic Data Generator for Reports
...
class ReportsFixtureGenerator:
    """
    Generates synthetic realistic records for reports.
    """
    ...
    def generate_synthetic_records(cls, count: int = 50) -> List[Dict[str, Any]]:
        ...
        for i in range(1, count + 1):
            ...
            rec = {
                "id": i,
                "name": f"Reports Synthetic Asset #{i:04d}",
                "code": f"IFX-REP-{i:05d}",
