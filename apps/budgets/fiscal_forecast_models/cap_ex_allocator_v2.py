"""
InfraFlowX Enterprise Domain Engine: CapExAllocator (Version 2.0)
...
class CapExAllocatorV2:
    """
    Production-grade enterprise domain service for CapExAllocator (Tier 2).
