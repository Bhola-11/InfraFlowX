"""
InfraFlowX Enterprise Domain Engine: CapExAllocator (Version 3.0)
...
class CapExAllocatorV3:
    """
    Production-grade enterprise domain service for CapExAllocator (Tier 3).
