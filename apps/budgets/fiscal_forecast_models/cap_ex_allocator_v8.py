"""
InfraFlowX Enterprise Domain Engine: CapExAllocator (Version 8.0)
...
class CapExAllocatorV8:
    """
    Production-grade enterprise domain service for CapExAllocator (Tier 8).
