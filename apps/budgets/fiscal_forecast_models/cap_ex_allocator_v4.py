"""
InfraFlowX Enterprise Domain Engine: CapExAllocator (Version 4.0)
...
class CapExAllocatorV4:
    """
    Production-grade enterprise domain service for CapExAllocator (Tier 4).
