"""
InfraFlowX Enterprise Domain Engine: CapExAllocator (Version 6.0)
...
class CapExAllocatorV6:
    """
    Production-grade enterprise domain service for CapExAllocator (Tier 6).
