"""
InfraFlowX Enterprise Domain Engine: CapExAllocator (Version 1.0)
...
class CapExAllocatorV1:
    """
    Production-grade enterprise domain service for CapExAllocator (Tier 1).
