"""
InfraFlowX - JSON Schema & API Data Contract Definitions for Budgets App
Enforces strict schema validation for REST endpoints and external webhook integrations.
"""

from typing import Dict, Any

BUDGETS_SCHEMA: Dict[str, Any] = {
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "title": "BudgetsPayloadSchema",
    "type": "object",
    "properties": {
        "id": {"type": "integer"},
...
def validate_budgets_payload(payload: Dict[str, Any]) -> bool:
