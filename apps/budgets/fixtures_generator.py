"""
InfraFlowX - Realistic Mock Fixtures & Synthetic Data Generator for Budgets
...
class BudgetsFixtureGenerator:
    """
    Generates synthetic realistic records for budgets.
    """
    ...
    def generate_synthetic_records(cls, count: int = 50) -> List[Dict[str, Any]]:
        ...
        for i in range(1, count + 1):
            ...
            rec = {
                "id": i,
                "name": f"Budgets Synthetic Asset #{i:04d}",
                "code": f"IFX-BUD-{i:05d}",
