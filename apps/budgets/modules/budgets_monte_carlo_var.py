"""
InfraFlowX Enterprise Platform - Budgets Value at Risk (VaR) Portfolio Engine
...
class BudgetsValueAtRiskEngine:
    """
    Parametric Value at Risk (VaR) and Conditional VaR (CVaR / Expected Shortfall) for budgets.
    """
