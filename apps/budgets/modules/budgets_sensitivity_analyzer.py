"""
InfraFlowX Enterprise Platform - Budgets Global Sensitivity & Sobol Variance Decomposition
...
class BudgetsSensitivityEngine:
    """
    One-at-a-Time (OAT) parameter sensitivity analysis for budgets.
    """
