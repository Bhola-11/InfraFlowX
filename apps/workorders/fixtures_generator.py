"""
InfraFlowX - Realistic Mock Fixtures & Synthetic Data Generator for Workorders
...
class WorkordersFixtureGenerator:
    """
    Generates synthetic realistic records for workorders.
    """
    ...
    def generate_synthetic_records(cls, count: int = 50) -> List[Dict[str, Any]]:
        ...
        for i in range(1, count + 1):
            ...
            rec = {
                "id": i,
                "name": f"Workorders Synthetic Asset #{i:04d}",
                "code": f"IFX-WOR-{i:05d}",
