"""
InfraFlowX - JSON Schema & API Data Contract Definitions for Workorders App
Enforces strict schema validation for REST endpoints and external webhook integrations.
"""

from typing import Dict, Any

WORKORDERS_SCHEMA: Dict[str, Any] = {
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "title": "WorkordersPayloadSchema",
    "type": "object",
    "properties": {
        "id": {"type": "integer"},
...
def validate_workorders_payload(payload: Dict[str, Any]) -> bool:
