"""
InfraFlowX Enterprise Platform - Workorders Global Sensitivity & Sobol Variance Decomposition
...
class WorkordersSensitivityEngine:
    """
    One-at-a-Time (OAT) parameter sensitivity analysis for workorders.
    """
