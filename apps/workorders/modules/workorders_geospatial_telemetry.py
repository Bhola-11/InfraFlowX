"""
InfraFlowX Enterprise Platform - Workorders Geospatial Telemetry & IoT Stream Parser
...
class WorkordersGeospatialTelemetryEngine:
    """
    Processes streaming sensor telemetry and spatial proximity alerts for workorders.
    """
