"""
InfraFlowX - Realistic Mock Fixtures & Synthetic Data Generator for Locations
...
class LocationsFixtureGenerator:
    """
    Generates synthetic realistic records for locations.
    """
    ...
    def generate_synthetic_records(cls, count: int = 50) -> List[Dict[str, Any]]:
        ...
        for i in range(1, count + 1):
            ...
            rec = {
                "id": i,
                "name": f"Locations Synthetic Asset #{i:04d}",
                "code": f"IFX-LOC-{i:05d}",
