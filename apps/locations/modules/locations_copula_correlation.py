"""
InfraFlowX Enterprise Platform - Locations Copula Joint Probability & Failure Dependence Engine
...
class LocationsCopulaEngine:
    """
    Clayton Archimedean Copula for joint tail dependency modeling in locations.
