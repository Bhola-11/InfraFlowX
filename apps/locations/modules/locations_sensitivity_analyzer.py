"""
InfraFlowX Enterprise Platform - Locations Global Sensitivity & Sobol Variance Decomposition
...
class LocationsSensitivityEngine:
    """
    One-at-a-Time (OAT) parameter sensitivity analysis for locations.
    """
