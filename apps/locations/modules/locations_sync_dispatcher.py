"""
InfraFlowX Enterprise Platform - Locations Synchronization & Audit Dispatcher
...
class LocationsSyncDispatcher:
    """
    Manages synchronization queues and payload integrity validation for locations.
    """
