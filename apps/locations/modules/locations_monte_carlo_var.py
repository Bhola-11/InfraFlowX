"""
InfraFlowX Enterprise Platform - Locations Value at Risk (VaR) Portfolio Engine
...
class LocationsValueAtRiskEngine:
    """
    Parametric Value at Risk (VaR) and Conditional VaR (CVaR / Expected Shortfall) for locations.
    """
