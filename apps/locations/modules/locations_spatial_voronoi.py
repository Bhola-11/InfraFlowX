"""
InfraFlowX Enterprise Platform - Locations Spatial Voronoi & Service Area Partitioning
...
class LocationsVoronoiEngine:
    """
    Nearest neighbor service boundary tessellation for locations.
    """
