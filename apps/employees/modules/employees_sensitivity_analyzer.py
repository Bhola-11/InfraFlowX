"""
InfraFlowX Enterprise Platform - Employees Global Sensitivity & Sobol Variance Decomposition
...
class EmployeesSensitivityEngine:
    """
    One-at-a-Time (OAT) parameter sensitivity analysis for employees.
    """
