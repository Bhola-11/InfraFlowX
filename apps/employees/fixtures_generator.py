"""
InfraFlowX - Realistic Mock Fixtures & Synthetic Data Generator for Employees
...
class EmployeesFixtureGenerator:
    """
    Generates synthetic realistic records for employees.
    """
    ...
    def generate_synthetic_records(cls, count: int = 50) -> List[Dict[str, Any]]:
        ...
        for i in range(1, count + 1):
            ...
            rec = {
                "id": i,
                "name": f"Employees Synthetic Asset #{i:04d}",
                "code": f"IFX-EMP-{i:05d}",
