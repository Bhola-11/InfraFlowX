"""
InfraFlowX Enterprise Platform - Analytics Global Sensitivity & Sobol Variance Decomposition
...
class AnalyticsSensitivityEngine:
    """
    One-at-a-Time (OAT) parameter sensitivity analysis for analytics.
    """
