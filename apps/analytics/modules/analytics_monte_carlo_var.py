"""
InfraFlowX Enterprise Platform - Analytics Value at Risk (VaR) Portfolio Engine
...
class AnalyticsValueAtRiskEngine:
    """
    Parametric Value at Risk (VaR) and Conditional VaR (CVaR / Expected Shortfall) for analytics.
    """
