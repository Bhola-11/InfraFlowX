"""
InfraFlowX - Realistic Mock Fixtures & Synthetic Data Generator for Analytics
...
class AnalyticsFixtureGenerator:
    """
    Generates synthetic realistic records for analytics.
    """
    ...
    def generate_synthetic_records(cls, count: int = 50) -> List[Dict[str, Any]]:
        ...
        for i in range(1, count + 1):
            ...
            rec = {
                "id": i,
                "name": f"Analytics Synthetic Asset #{i:04d}",
                "code": f"IFX-ANA-{i:05d}",
