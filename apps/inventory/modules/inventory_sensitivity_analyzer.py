"""
InfraFlowX Enterprise Platform - Inventory Global Sensitivity & Sobol Variance Decomposition
...
class InventorySensitivityEngine:
    """
    One-at-a-Time (OAT) parameter sensitivity analysis for inventory.
    """
