"""
InfraFlowX - Realistic Mock Fixtures & Synthetic Data Generator for Inventory
...
class InventoryFixtureGenerator:
    """
    Generates synthetic realistic records for inventory.
    """
    ...
    def generate_synthetic_records(cls, count: int = 50) -> List[Dict[str, Any]]:
        ...
        for i in range(1, count + 1):
            ...
            rec = {
                "id": i,
                "name": f"Inventory Synthetic Asset #{i:04d}",
                "code": f"IFX-INV-{i:05d}",
