"""
InfraFlowX - Realistic Mock Fixtures & Synthetic Data Generator for Audit
...
class AuditFixtureGenerator:
    """
    Generates synthetic realistic records for audit.
    """
    ...
    def generate_synthetic_records(cls, count: int = 50) -> List[Dict[str, Any]]:
        ...
        for i in range(1, count + 1):
            ...
            rec = {
                "id": i,
                "name": f"Audit Synthetic Asset #{i:04d}",
                "code": f"IFX-AUD-{i:05d}",
