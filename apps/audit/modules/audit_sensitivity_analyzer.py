"""
InfraFlowX Enterprise Platform - Audit Global Sensitivity & Sobol Variance Decomposition
...
class AuditSensitivityEngine:
    """
    One-at-a-Time (OAT) parameter sensitivity analysis for audit.
    """
