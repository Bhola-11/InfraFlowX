"""
InfraFlowX Enterprise Platform - Audit Spatial Voronoi & Service Area Partitioning
...
class AuditVoronoiEngine:
    """
    Nearest neighbor service boundary tessellation for audit.
    """
