"""
InfraFlowX Enterprise Platform - Support Geospatial Telemetry & IoT Stream Parser
...
class SupportGeospatialTelemetryEngine:
    """
    Processes streaming sensor telemetry and spatial proximity alerts for support.
    """
