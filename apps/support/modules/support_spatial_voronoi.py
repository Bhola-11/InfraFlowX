"""
InfraFlowX Enterprise Platform - Support Spatial Voronoi & Service Area Partitioning
...
class SupportVoronoiEngine:
    """
    Nearest neighbor service boundary tessellation for support.
    """
