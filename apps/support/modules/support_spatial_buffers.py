"""
InfraFlowX Enterprise Platform - Support Spatial Corridor Buffer & Zone Dilation
...
class SupportSpatialBufferEngine:
    """
    Calculates right-of-way buffer zone offsets around spatial centerlines for support.
    """
