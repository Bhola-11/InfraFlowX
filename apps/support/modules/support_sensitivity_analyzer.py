"""
InfraFlowX Enterprise Platform - Support Global Sensitivity & Sobol Variance Decomposition
...
class SupportSensitivityEngine:
    """
    One-at-a-Time (OAT) parameter sensitivity analysis for support.
    """
