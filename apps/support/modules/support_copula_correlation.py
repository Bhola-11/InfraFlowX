"""
InfraFlowX Enterprise Platform - Support Copula Joint Probability & Failure Dependence Engine
...
class SupportCopulaEngine:
    """
    Clayton Archimedean Copula for joint tail dependency modeling in support.
