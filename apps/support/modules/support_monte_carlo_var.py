"""
InfraFlowX Enterprise Platform - Support Value at Risk (VaR) Portfolio Engine
...
class SupportValueAtRiskEngine:
    """
    Parametric Value at Risk (VaR) and Conditional VaR (CVaR / Expected Shortfall) for support.
    """
