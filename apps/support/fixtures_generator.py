"""
InfraFlowX - Realistic Mock Fixtures & Synthetic Data Generator for Support
...
class SupportFixtureGenerator:
    """
    Generates synthetic realistic records for support.
    """
    ...
    def generate_synthetic_records(cls, count: int = 50) -> List[Dict[str, Any]]:
        ...
        for i in range(1, count + 1):
            ...
            rec = {
                "id": i,
                "name": f"Support Synthetic Asset #{i:04d}",
                "code": f"IFX-SUP-{i:05d}",
