"""
InfraFlowX - Realistic Mock Fixtures & Synthetic Data Generator for Conditions
...
class ConditionsFixtureGenerator:
    """
    Generates synthetic realistic records for conditions.
    """
    ...
    def generate_synthetic_records(cls, count: int = 50) -> List[Dict[str, Any]]:
        ...
        for i in range(1, count + 1):
            ...
            rec = {
                "id": i,
                "name": f"Conditions Synthetic Asset #{i:04d}",
