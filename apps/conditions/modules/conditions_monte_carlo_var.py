"""
InfraFlowX Enterprise Platform - Conditions Value at Risk (VaR) Portfolio Engine
...
class ConditionsValueAtRiskEngine:
    """
    Parametric Value at Risk (VaR) and Conditional VaR (CVaR / Expected Shortfall) for conditions.
    """
