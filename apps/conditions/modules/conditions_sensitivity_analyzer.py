"""
InfraFlowX Enterprise Platform - Conditions Global Sensitivity & Sobol Variance Decomposition
...
class ConditionsSensitivityEngine:
    """
    One-at-a-Time (OAT) parameter sensitivity analysis for conditions.
    """
