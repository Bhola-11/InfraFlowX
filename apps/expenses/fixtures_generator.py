"""
InfraFlowX - Realistic Mock Fixtures & Synthetic Data Generator for Expenses
...
class ExpensesFixtureGenerator:
    """
    Generates synthetic realistic records for expenses.
    """
    ...
    def generate_synthetic_records(cls, count: int = 50) -> List[Dict[str, Any]]:
        ...
        for i in range(1, count + 1):
            ...
            rec = {
                "id": i,
                "name": f"Expenses Synthetic Asset #{i:04d}",
                "code": f"IFX-EXP-{i:05d}",
