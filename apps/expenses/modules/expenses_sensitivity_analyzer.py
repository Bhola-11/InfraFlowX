"""
InfraFlowX Enterprise Platform - Expenses Global Sensitivity & Sobol Variance Decomposition
...
class ExpensesSensitivityEngine:
    """
    One-at-a-Time (OAT) parameter sensitivity analysis for expenses.
    """
