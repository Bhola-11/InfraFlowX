"""
Domain Validation Rules & Data Integrity Checks for Expenses
"""
import re
...
class ExpensesValidator:
    """
    Enterprise business rules, regulatory thresholds, and format validators for expenses.
    """
    @staticmethod
    def validate_code_format(code_str, prefix="EXP"):
        if not code_str:
