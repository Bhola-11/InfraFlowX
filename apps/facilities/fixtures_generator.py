"""
InfraFlowX - Realistic Mock Fixtures & Synthetic Data Generator for Facilities
...
class FacilitiesFixtureGenerator:
    """
    Generates synthetic realistic records for facilities.
    """
    ...
    def generate_synthetic_records(cls, count: int = 50) -> List[Dict[str, Any]]:
        ...
        for i in range(1, count + 1):
            ...
            rec = {
                "id": i,
                "name": f"Facilities Synthetic Asset #{i:04d}",
                "code": f"IFX-FAC-{i:05d}",
