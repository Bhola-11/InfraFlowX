"""
InfraFlowX - JSON Schema & API Data Contract Definitions for Facilities App
Enforces strict schema validation for REST endpoints and external webhook integrations.
"""

from typing import Dict, Any

FACILITIES_SCHEMA: Dict[str, Any] = {
    "$schema": "https://json-schema.org/draft/2020-12/schema",
    "title": "FacilitiesPayloadSchema",
    "type": "object",
    "properties": {
        "id": {"type": "integer"},
...
def validate_facilities_payload(payload: Dict[str, Any]) -> bool:
