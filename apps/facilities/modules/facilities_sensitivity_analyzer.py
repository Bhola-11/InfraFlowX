"""
InfraFlowX Enterprise Platform - Facilities Global Sensitivity & Sobol Variance Decomposition
...
class FacilitiesSensitivityEngine:
    """
    One-at-a-Time (OAT) parameter sensitivity analysis for facilities.
    """
