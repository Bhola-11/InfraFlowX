"""
InfraFlowX Enterprise Platform - Facilities Value at Risk (VaR) Portfolio Engine
...
class FacilitiesValueAtRiskEngine:
    """
    Parametric Value at Risk (VaR) and Conditional VaR (CVaR / Expected Shortfall) for facilities.
    """
